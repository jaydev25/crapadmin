...
export class EditprofileComponent implements OnInit {
    ...
    constructor(public fb: FormBuilder, private modalService: NgbModal,
                ...
                private editProfilesandbox: EditprofileSandbox, public editProfileService: EditprofileService,
    ...
    save(user) {
        ...
        param.firstName = this.editProfileForm.value.FirstName;
        param.lastName = this.editProfileForm.value.LastName;
    ...
    EditProfilelist() {
        ...
        this.editProfileForm.controls['FirstName'].setValue(this.profileData.firstName);
        this.editProfileForm.controls['LastName'].setValue(this.profileData.lastName);
